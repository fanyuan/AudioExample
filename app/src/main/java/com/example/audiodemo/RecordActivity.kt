...
class RecordActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        audioPcmPath = getExternalFilesDir(Environment.DIRECTORY_MUSIC)?.absolutePath.toString() + File.separator + "hello/test.pcm"
        audioWavPath = getExternalFilesDir(Environment.DIRECTORY_MUSIC)?.absolutePath.toString() + File.separator + "hello/test.wav"
    }
